<div class="container-fluid mc">
	<div class="row mar-l-r badge-light">
		<div class="col-lg-4 ">
			<a href="index.php?view=trangchu" ><img class="logo" src="include/logoAn.png" ></a>
		...
		<div class="col-3">
			...
			<h5 class=" text-danger">1900 2023</h5>
			</div>
		   ...
		   <div class="carousel-inner  ">
		      ...
		      <div class="carousel-item">
		         <img class="d-block  slide banner" src="include/img/4.png" alt="Cat">
                       ...
                       <div class="carousel-item">
		         <img class="d-block  slide banner" src="include/img/5.png" alt="Cat">
		      </div>
